...
import com.droidar2.system.SimpleLocationManager;
...
/**
 * This com.droidar2.util class is a collection of all common location related operations
...
//			Document kml = getDocumentFromUrl(url);
	...
	public static String getDistanceString(double distance) {
		String shuttlDistance="" ;//= Long.toString(distance);
		if (distance / 1000 < 1d) {
			shuttlDistance = shuttlDistance + (int)distance + " m";
		} else {
			DecimalFormat df = new DecimalFormat("#.#");
			df.setRoundingMode(RoundingMode.CEILING);
			shuttlDistance = df.format(distance/1000) + " km";
		}
		return shuttlDistance;
	}
