package com.droidar2.commands.undoable;
...
public class CommandProcessorList extends ArrayList<UndoableCommand> {
	...
	public boolean add(UndoableCommand object) {
		// if there are redo com.droidar2.commands after the current pos then remove these
	...
	public boolean undo() {
		// dont delete the com.droidar2.commands that are undone, just move myPos curser and
		// undo them:
	...
	/**
	 * @param x
	 *            the number of com.droidar2.commands to be removed
	 */
