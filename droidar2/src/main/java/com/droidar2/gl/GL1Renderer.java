...
public class GL1Renderer extends GLRenderer {
	...
	public void onSurfaceChanged(GL10 gl, int width, int height) {
		 ...
		 * coordinate com.droidar2.system (+Z into the screen) contained within a canonical
		 ...
		 * to view space, using a right-handed coordinate com.droidar2.system with +Y up, +X
	...
	public void onSurfaceCreated(GL10 gl, EGLConfig config) {
		...
		/*
		 * To enable flat shading use com.droidar2.gl.glShadeModel(GL10.GL_FLAT); default is
		...
		// com.droidar2.gl.glHint(GL10.GL_PERSPECTIVE_CORRECTION_HINT, GL10.GL_FASTEST);
		...
		// com.droidar2.gl.glBlendFunc(GL10.GL_SRC_ALPHA, GL10.GL_ONE_MINUS_DST_ALPHA);
