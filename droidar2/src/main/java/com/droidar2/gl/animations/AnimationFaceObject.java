...
/**
 * Created by pallavahooja on 01/09/16.
 */
public class AnimationFaceObject extends GLAnimation{
     ...
     */
    public AnimationFaceObject(Obj obj, float updateDelay,
                               boolean dontChangeXRotation) {
        myTargetObj = obj;

        myUpdateDelay = updateDelay;
        myTargetCameraPosition = myTargetObj.getPosition();
        this.dontChangeXRotation = dontChangeXRotation;
        // Log.d("face camera animation", "created. camera=" + myTargetObj
        // + " targetMesh class=" + myTargetMesh.getClass()
        // + " update delay=" + myUpdateDelay);
    }

    public AnimationFaceObject(Obj obj, float updateDelay) {
        this(obj, updateDelay, true);
    }

    public AnimationFaceObject(Obj obj) {
        this(obj, 0.5f, false);
    }
