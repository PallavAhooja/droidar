...
import com.droidar2.util.Calculus;
import com.droidar2.util.HasDebugInformation;
...
import com.droidar2.actions.ActionUseCameraAngles2;
...
public class GLCamera implements Updateable, HasDebugInformation, Renderable,
	...
	// might be references in com.droidar2.commands to those objects so check where those are
	// set to null!
	// @Deprecated
	 ...
	 * (non-Javadoc)
	 * 
	 * @see com.droidar2.gl.GLCamRotationController#setRotationMatrix(float[], int)
	 */
	@Override
	 ...
	 * z axis, so the the camera is moved along the camera coordinate com.droidar2.system and
	 * not the world coordinate com.droidar2.system
	 * 
	 * @param deltaX
	 * @param deltaY
	 */
	 ...
	 * (non-Javadoc)
	 * 
	 * @see com.droidar2.gl.GLCamRotationController#resetBufferedAngle()
	 */
	@Override
	@Deprecated
	 ...
	 * (non-Javadoc)
	 * 
	 * @see com.droidar2.gl.GLCamRotationController#changeZAngleBuffered(float)
	 */
	@Override
	@Deprecated
