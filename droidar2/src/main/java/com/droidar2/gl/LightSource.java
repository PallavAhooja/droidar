...
public class LightSource extends MeshComponent {
	...
	private void setDefaultSimpleMaterialStuff(GL10 gl) {
		...
		// otherMaterialStuffThatDoesNotWork(com.droidar2.gl);
	...
	//
	// private void otherMaterialStuffThatDoesNotWork(GL10 com.droidar2.gl) {
	...
	// msb.position(0);
	//
	// com.droidar2.gl.glMaterialfv(GL10.GL_FRONT_AND_BACK, GL10.GL_AMBIENT, mab);
	// com.droidar2.gl.glMaterialfv(GL10.GL_FRONT_AND_BACK, GL10.GL_DIFFUSE, mdb);
	// com.droidar2.gl.glMaterialfv(GL10.GL_FRONT_AND_BACK, GL10.GL_SPECULAR, msb);
	// com.droidar2.gl.glMaterialf(GL10.GL_FRONT_AND_BACK, GL10.GL_SHININESS, 128.0f);
	// }
