...
import com.droidar2.gl.HasPosition;
import com.droidar2.gl.HasRotation;
import com.droidar2.gl.HasScale;
...
public abstract class MeshComponent implements RenderableEntity,
	 ...
	 * @return the coordinates in the world com.droidar2.system
	 */
