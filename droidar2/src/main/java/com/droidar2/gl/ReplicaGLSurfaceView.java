 ...
 * composited into the Android view com.droidar2.system.
 ...
 * of the View com.droidar2.system input event methods. If your application does not need to
...
public class ReplicaGLSurfaceView extends SurfaceView implements
	...
	/**
	 * Log GL calls to the com.droidar2.system log at "verbose" level with tag
	 * "GLSurfaceView".
	 * 
	 * @see #getDebugFlags
	 * @see #setDebugFlags
	 ...
	 * <p>
	 * Using RENDERMODE_WHEN_DIRTY can improve battery life and overall com.droidar2.system
	 ...
	 *     GL wrap(GL com.droidar2.gl) {
	 *         return new MyGLImplementation(com.droidar2.gl);
	 *     }
	...
	public interface GLWrapper {
		/**
		 * Wraps a com.droidar2.gl interface in another com.droidar2.gl interface.
		 * 
		 * @param gl
	...
	public interface ReplicaRenderer {
		 ...
		 * 
		 * <pre class="prettyprint">
		 * void onSurfaceChanged(GL10 com.droidar2.gl, int width, int height) {
		 * 	com.droidar2.gl.glViewport(0, 0, width, height);
		 * 	// for a fixed camera, set the projection too
		 * 	float ratio = (float) width / height;
		 * 	com.droidar2.gl.glMatrixMode(GL10.GL_PROJECTION);
		 * 	com.droidar2.gl.glLoadIdentity();
		 * 	com.droidar2.gl.glFrustumf(-ratio, ratio, -1, 1, 1, 10);
		 * }
		 * </pre>
		 * 
		 * @param gl
		 ...
		 * 
		 * <pre class="prettyprint">
		 * void onDrawFrame(GL10 com.droidar2.gl) {
		 * 	com.droidar2.gl.glClear(GL10.GL_COLOR_BUFFER_BIT | GL10.GL_DEPTH_BUFFER_BIT);
		 * 	// ... other com.droidar2.gl calls to render the scene ...
		 * }
		 * </pre>
		 * 
		 * @param gl
	...
	private class EglHelper {
		...
		public GL createSurface(SurfaceHolder holder) {
			...
			/*
			 * Before we can issue GL com.droidar2.commands, we need to make sure the context
			...
			try {
				...
				while (true) {
					...
					if (mHasFocus) {
						...
						// before
						// issuing any GL com.droidar2.commands. Don't ask me how long it
						// took
						// to figure this out.
