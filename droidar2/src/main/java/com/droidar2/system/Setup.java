...
import com.droidar2.gamelogic.FeedbackReports;
...
import com.droidar2.gl.ObjectPicker;
import com.droidar2.gl.textures.TextureManager;
import com.droidar2.gui.GuiSetup;
import com.droidar2.gui.InfoScreen;
...
import com.droidar2.commands.CommandGroup;
import com.droidar2.commands.system.CommandDeviceVibrate;
...
public abstract class Setup {
	...
	private static final String STEP5 = "Initializing com.droidar2.system values";
	...
	private static final String STEP10 = "Creating com.droidar2.gui overlay";
	...
	public void run(Activity target) {
		...
		// set sensorinput com.droidar2.actions:
	 ...
	 * {@link ErrorHandler} com.droidar2.system provided by DroidAR will be deactivated (e.g.
	 * while debugging)
	 */
			...
			public boolean execute() {
				SimpleUIv1.showInfoScreen(currentActivity, new EditItem() {
					...
					public void customizeScreen(ModifierGroup group,
							Object message) {
						group.addModifier(new com.droidar2.gui.simpleUI.modifiers.Headline(
								R.drawable.logo, "DroidAR"));
						group.addModifier(new com.droidar2.gui.simpleUI.modifiers.InfoText(
