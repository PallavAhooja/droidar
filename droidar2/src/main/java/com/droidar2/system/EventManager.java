...
public class EventManager implements LocationListener, SensorEventListener {
	...
	// all the predefined com.droidar2.actions:
	 ...
	 * Android com.droidar2.system values.
	 * 
	...
	public GeoObj getCurrentLocationObject() {
		...
		// if its still null set it to a default com.droidar2.geo-object:
		if (currentLocation == null) {
	...
	// /**
	// * The Android com.droidar2.system will be asked directly and if the external location
