...
import com.droidar2.gestures.detectors.DummyDetector;
import com.droidar2.gestures.detectors.FullTurnDetector;
import com.droidar2.gestures.detectors.LoggingDetector;
import com.droidar2.gestures.detectors.LookingDetector;
import com.droidar2.gestures.detectors.SlashDetector;
import com.droidar2.gestures.detectors.UppercutDetector;
 ...
 * sensors and detects special com.droidar2.gestures that are made with the phone. Gestures
 ...
 * {@link PhoneGestureDetector} interface. The sensor notifies all its com.droidar2.listeners
...
public class PhoneGestureSensor implements SensorEventListener {
	...
	/**
	 * A list of registered event com.droidar2.listeners.
	 */
	...
	/**
	 * The minimal amount of time between to com.droidar2.gestures in milliseconds.
	 */
	public long gestureTimeout = 500;

	/**
	 * Creates a new sensor instance that will be looking for phone com.droidar2.gestures.
	 * 
	 * @param context
	...
	private float[] getLinearAcceleration(SensorEvent event) {
		...
		case Sensor.TYPE_ACCELEROMETER:
			// High pass filtering to remove gravity (see also goo.com.droidar2.gl/dl85N)
	...
	/**
	 * Notifies all registered com.droidar2.listeners of the event that occurred.
	 * 
	 * @param phoneGesture
	...
	private void propagateEvent(PhoneGesture phoneGesture) {
		...
		// We copy the current list of com.droidar2.listeners into an array to achieve
		// thread safety since new com.droidar2.listeners could be registered while
	...
	/**
	 * Pauses detection of com.droidar2.gestures for all registered com.droidar2.listeners. Use with
	 * caution.
	 */
	public void pause() {
	...
	/**
	 * Resumes detection of com.droidar2.gestures.
	 */
	public void resume() {
