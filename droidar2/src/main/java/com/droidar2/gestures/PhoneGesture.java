...
/**
 * To identify com.droidar2.gestures in a structured way, we're making use of the
 * "Extensible Enum Pattern". When creating your own com.droidar2.gestures, create an enum
