...
import com.droidar2.gl.CordinateAxis;
...
public class World implements RenderableEntity, Container<RenderableEntity> {
	...
	// private void glLoadRotation(GL10 com.droidar2.gl) {
	// if (myRotation != null) {
	// // see MeshComponent and GLCamera for more infos why this order is
	// // important:
	// com.droidar2.gl.glRotatef(myRotation.z, 0, 0, 1);
	// com.droidar2.gl.glRotatef(myRotation.x, 1, 0, 0);
	// com.droidar2.gl.glRotatef(myRotation.y, 0, 1, 0);
	// }
	// }
	...
	public void render(GL10 gl, Renderable parent) {
		...
		// glLoadRotation(com.droidar2.gl);
		glLoadScale(gl);
